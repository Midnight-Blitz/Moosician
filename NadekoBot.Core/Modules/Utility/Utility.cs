        ...
        public async Task Stats()
        {
            ...
            await Context.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"Moosician v{StatsService.BotVersion}.m")
                                          .WithUrl("https://github.com/Midnight-Blitz/Moosician")
                                          .WithIconUrl("https://cdn.discordapp.com/avatars/341297873939464193/9f0716501291a996c8783f2af637a16d.png")) ///MAKE THIS SELF-HOSTED!
                    ...
                    .AddField(efb => efb.WithName(GetText("memory")).WithValue($"{_stats.Heap} MB").WithIsInline(true))).ConfigureAwait(false);
        }
