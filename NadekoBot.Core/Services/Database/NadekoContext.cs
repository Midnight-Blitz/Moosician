        ...
        public void EnsureSeedData()
        {
            if (!BotConfig.Any())
            {
                ...
                bc.EightBallResponses.AddRange(new HashSet<EightBallResponse>
                {
                    ...
                    new EightBallResponse() { Text = "Totes" },
                    new EightBallResponse() { Text = "Roll a d20" },
                    ...
                    new EightBallResponse() { Text = "Crit fail! `1d20` = (1) = 1. Rocks fall, you die." },
                    ...
                    new EightBallResponse() { Text = "NO - Absolutely not!" }
                });
